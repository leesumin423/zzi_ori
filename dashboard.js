...
function guideFtcHtml() {
  return `
    <p class="info">공정거래법상 대규모내부거래(계열회사간 거래) 공시 3종(특수관계인에대한출자ㆍ채권매도, 동일인등출자
    계열회사와의상품ㆍ용역거래)의 서식 항목과 관련법규를 정리했습니다. 세 유형 모두 이사회 의결 후 공시라는 절차는
    같지만 서식에 들어가는 항목은 유형별로 다릅니다.</p>

    <h4>1. 유형별 서식 항목</h4>
    ${guideFieldsHtml([
      { label: '[특수관계인에대한출자] 거래상대방 / 회사와의 관계', note: '' },
      { label: '[특수관계인에대한출자] 출자일자 / 출자목적물 / 출자금액', note: '' },
      { label: '[특수관계인에대한출자] 출자상대방 총출자액 / 출자목적', note: '누계액 기준' },
      { label: '[특수관계인에대한채권매도] 매도상대방 / 매도일자 / 거래금액', note: '' },
      { label: '[특수관계인에대한채권매도] 채권내역', note: '발행자, 종류, 권면금액, 자본금 대비(%), 표면이율, 발행일, 만기일' },
      { label: '[상품ㆍ용역거래] 해당회사의 직전사업연도매출액(A) / 거래상대방', note: '동일인 및 동일인 친족 출자 계열회사' },
      { label: '[상품ㆍ용역거래] 분기별 매출액(B)ㆍ매입액(C)ㆍ합계(D)ㆍ매출액대비(D/A,%)', note: '' },
      { label: '공통 — 이사회 의결일 / 사외이사 참석여부 / 감사(감사위원) 참석여부', note: '' },
    ])}

    <h4>2. 거래유형별 대상 판단기준 (사전검증 탭 참고)</h4>
    <ul>
      <li><b>자금ㆍ유가증권ㆍ자산 거래</b>: 특수관계인(국외 계열회사는 제외)이 상대방이면 거래금액 100억원 이상
        또는 자본총계ㆍ자본금 중 큰 금액의 5%(최소 5억원) 이상일 때 대상</li>
      <li><b>상품ㆍ용역 거래</b>: 위 금액기준을 충족해도 거래상대방이 "동일인 및 동일인 친족이 20% 이상 출자한
        계열회사(또는 그 50% 초과 자회사)"인 경우에만 대상 — 일반 계열회사 전부가 아님</li>
    </ul>

    <h4>3. 관련법규 (클릭하면 조문이 펼쳐집니다)</h4>
    ${lawArticle('독점규제 및 공정거래에 관한 법률 제26조(대규모내부거래의 이사회 의결 및 공시) 제1항 요지',
      '특수관계인(국외 계열회사는 제외한다)을 상대방으로 하거나 특수관계인을 위하여 다음 각 호의 어느 하나에 해당하는 거래행위를 하려는 경우에는 미리 이사회의 의결을 거친 후 이를 공시하여야 한다.\n1. 가지급금 또는 대여금 등의 자금을 제공 또는 거래하는 행위\n2. 주식 또는 회사채 등의 유가증권을 제공 또는 거래하는 행위\n3. 부동산 또는 무체재산권 등의 자산을 제공 또는 거래하는 행위\n4. 주주의 구성 등을 고려하여 대통령령으로 정하는 계열회사를 상대방으로 하거나 그 계열회사를 위하여 상품 또는 용역을 제공 또는 거래하는 행위')}
    ${lawArticle('같은 법 시행령 제33조(대규모내부거래의 이사회 의결 및 공시) 제1항ㆍ제2항 요지',
      '① 법 제26조제1항 각 호에 따른 거래행위의 규모는 그 거래금액(상품ㆍ용역 거래의 경우에는 분기에 이루어질 거래금액의 합계액을 말한다)이 100억원 이상이거나 그 회사의 자본총계 또는 자본금 중 큰 금액의 100분의 5 이상인 것으로 한다.\n\n② 법 제26조제1항제4호에서 "대통령령으로 정하는 계열회사"란 자연인인 동일인이 단독으로 또는 동일인의 친족과 합하여 발행주식 총수의 100분의 20 이상을 소유하고 있는 계열회사 또는 그 계열회사의 「상법」 제342조의2에 따른 자회사인 계열회사를 말한다.')}

    <h4>4. 공시시기</h4>
    <p>이사회 의결 후 <b>상장법인 3영업일 이내</b>, 비상장법인ㆍ공익법인은 7영업일 이내 공시.</p>
    <p class="rule-cite">출처: 독점규제 및 공정거래에 관한 법률 제26조, 동법 시행령 제33조, 공정위 고시 "대규모내부거래 등에 대한 이사회 의결 및 공시에 관한 규정".</p>`;
}
