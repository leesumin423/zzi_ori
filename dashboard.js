...
// text 안에서 ⟦...⟧로 감싼 부분(기준이 되는 금액ㆍ일수ㆍ날짜ㆍ비율)은 강조 표시된다.
function lawArticle(name, text) {
  const escaped = escapeAttr(text).replace(/⟦/g, '<b class="num-hl">').replace(/⟧/g, '</b>');
  return `<details class="law-article"><summary>${escapeAttr(name)}</summary><div class="law-article-text">${escaped}</div></details>`;
}
...
function ruleDanpanHtml(rule) {
  ...
  return `
    ...
    <h4>계약의 범위 구분</h4>
    <ul>
      <li>단일판매계약과 공급계약에 대한 범위구분이 명확하지 않으나, 건설업의 경우 공사수주(단일판매계약)와
        유통업의 경우 상품공급(공급계약)을 포함한 법인의 경영활동에서의 제품 등의 판매활동을 의미합니다.</li>
      <li>회사의 매출액에 반영되는 수주ㆍ공급계약만 해당되며, <b>해당 회사의 발주 및 구매계약은 공시대상이
        아닙니다</b> — 동양(주)이 파는 계약(매출)만 대상이고, 동양(주)이 사는 계약(매입ㆍ발주)은 대상이 아닙니다.</li>
      <li>계약금액은 부가가치세(VAT)를 제외한 금액으로 합니다.</li>
    </ul>

    <h4>계약확정시점과 계약서 서명시점이 다른 경우</h4>
    <ul>
      <li>정부 또는 공공적 법인 등으로부터 발주받는 계약으로, 계약확정시점과 계약서 서명시점이 다른 경우에는
        <b>계약확정시점에서 공시</b>하고, 향후 서명 날인 후 지체없이 계약서를 추가로 제출해야 합니다.</li>
      <li>계약상대방과의 이해관계 등에 따라 계약의 변경ㆍ해지 등이 발생하면 반드시 관련 사항을 공시해야 합니다.</li>
    </ul>

    <h4>시장조치 관련 중요사항</h4>
    <p class="info">현재 특별히 안내된 시장조치 관련 중요사항은 없습니다. (거래소가 공지사항으로 수시 갱신하는
    항목이라, 실제 신고 전에는 <a href="https://kclic.krx.co.kr" target="_blank" class="clickable-name">K-CLIC
    공시종합지원시스템</a>에서 최신 공지를 다시 확인하는 것을 권장합니다.)</p>

    <h4>관련법규 (클릭하면 조문이 펼쳐집니다)</h4>
    ${lawArticle('유가증권시장 공시규정 제7조제1항제1호다목', '최근 사업연도 매출액의 100분의 5(대규모법인의 경우 1,000분의 25) 이상의 단일판매계약 또는 공급계약을 체결한 때 및 해당 계약을 해지한 때 — 사유발생일 다음 날까지 신고')}
    ${lawArticle('유가증권시장 공시규정 제43조의2 (신청에 의한 공시유보)', '경영상 비밀유지를 위하여 필요한 경우 계약금액ㆍ계약상대ㆍ주요 계약조건ㆍ해지금액ㆍ해지 주요사유 등에 대해 거래소에 공시유보를 신청할 수 있음 — 아래 "기타 주의사항" 참고')}
    ${lawArticle('유가증권시장 공시규정 시행세칙 제18조', '단판공시 서식이 인용하는 세부 시행세칙 조항 — 정확한 조문 원문은 KRX 법규서비스(rule.krx.co.kr)에서 최신본 확인이 필요합니다.')}

    <h4>기타 주의사항</h4>
    <p><b>계약금액 등의 공시유보 신청</b></p>
    <ul>
      <li>경영상 비밀보호를 위하여 필요한 경우 계약금액, 계약상대, 주요 계약조건, 해지금액, 해지 주요사유 등에
        대한 공시유보를 거래소에 신청할 수 있습니다.</li>
      <li>거래소는 기업 경영 등 비밀유지와 투자자 보호와의 형평성을 고려하여 공시유보가 필요하다고 인정되는
        경우 이를 승인합니다.</li>
      <li>공시유보 신청 시 상장법인은 유보기한을 기재해야 하며, 해당 유보기간이 만료되거나 유보조건이
        해제되는 경우 그 다음날까지 정정공시를 통해 유보된 내용을 신고해야 합니다 — 이를 이행하지 않으면
        공시불이행으로 제재받습니다.</li>
    </ul>
    <p><b>불성실공시 관련 특이사항</b></p>
    <ul>
      <li>상장법인이 현저한 시황변동 조회공시 요구에 응하여 답변공시한 후 <b>15일 이내(공시번복제한기간)</b>
        같은 내용의 공시를 하는 경우 <b>불성실공시(공시번복)</b>에 해당하므로 주의가 필요합니다.</li>
      <li>단일판매 또는 공급계약 금액의 <b>50% 이상을 변경</b>하여 공시한 때는 <b>공시변경</b>에 해당하므로
        주의가 필요합니다(위 "공시변경(재공시) 및 면제 기준" 참고).</li>
    </ul>
    <p class="rule-cite">근거: 유가증권시장 공시규정 제7조제1항제1호다목ㆍ제43조의2, 시행세칙 제18조 (출처:
    <a href="https://rule.krx.co.kr/out/index.do" target="_blank" class="clickable-name">KRX 법규서비스</a>,
    <a href="https://kclic.krx.co.kr" target="_blank" class="clickable-name">K-CLIC 공시종합지원시스템</a> —
    업무해설ㆍ계약범위구분ㆍ기타주의사항 문구는 K-CLIC 원문을 그대로 인용).
...
function ruleMgmtCommonHtml() {
  return `
    <p>보통주(동양)는 종가가 <b class="num-hl">1,000원 미만</b>인 상태가 <b class="num-hl">30매매거래일</b>
    연속되면 관리종목으로 지정됩니다 — 이른바 "동전주" 이슈에 대응해 신설된 조항입니다.</p>
    <div class="rule-flow">
      <div class="rule-flow-box">
        <div class="rule-flow-label">종가</div>
        <div class="rule-flow-value num-hl">1,000원 미만</div>
      </div>
      <div class="rule-flow-arrow">→</div>
      <div class="rule-flow-box">
        <div class="rule-flow-label">연속 매매거래일</div>
        <div class="rule-flow-value num-hl">30일 충족</div>
      </div>
      <div class="rule-flow-arrow">→</div>
      <div class="rule-flow-box highlight">
    ...
    <h4>상장폐지 기준 (제48조제1항제9호의2)</h4>
    ${lawArticle('유가증권시장 상장규정 제48조제1항제9호의2 (주가 미달, 2026.5.13 신설)',
      '제47조제1항제9호의2에 따라 관리종목으로 지정된 후 ⟦90일⟧(해당 보통주권의 매매거래일을 기준으로 한다) 이내에 다음 각 목의 어느 하나의 사유에 해당하는 경우 해당 보통주권을 상장폐지한다.\n가. 해당 보통주식의 종가가 ⟦1,000원 이상⟧인 상태가 ⟦45일 이상⟧ 계속되지 못하는 경우\n나. 주식병합 또는 자본금의 감소에 따른 변경상장을 완료한 경우로서 관리종목 지정일로부터 과거 ⟦1년⟧ 이내에 주식병합 또는 자본금의 감소에 따른 변경상장이 있었던 경우\n다. 주식병합 또는 자본금의 감소에 따른 변경상장을 1회 이상 완료한 경우로서 해당 주식병합 또는 자본금 감소의 총 비율이 ⟦10대1⟧을 초과하는 경우')}
    <p class="info">즉 관리종목 <b>지정</b>은 종가 <b class="num-hl">1,000원 미만</b>이 <b class="num-hl">30매매거래일
    연속</b>되면 발생하지만, 상장폐지를 면하려면 지정 후 <b class="num-hl">90매매거래일 이내</b>에 종가
    <b class="num-hl">1,000원 이상</b> 상태를 <b class="num-hl">45매매거래일 이상</b> 유지해야 합니다 —
    <b class="num-hl">30일</b>ㆍ<b class="num-hl">90일</b>ㆍ<b class="num-hl">45일</b> 세 가지 숫자가 각각
    지정ㆍ유예ㆍ해소 기준으로 다르게 쓰이니 혼동하지 않도록 주의하세요. 나ㆍ다목은 무상감자성 주식병합으로
    주가를 인위적으로 띄워 규정을 회피하는 것을 막는 보완장치입니다(지정일 전 <b class="num-hl">1년 이내</b>
    병합ㆍ감자 이력이 있거나, 누적 병합ㆍ감자 비율이 <b class="num-hl">10대1</b>을 넘으면 종가 기준 충족
    여부와 무관하게 상장폐지).</p>
    <h4>관리종목 지정 해제</h4>
  ...
  return `
    ...
    <div class="rule-flow">
      <div class="rule-flow-box">
        ...
        <div class="rule-flow-value num-hl">20억원 미만</div>
      </div>
      <div class="rule-flow-arrow">→</div>
      <div class="rule-flow-box">
        <div class="rule-flow-label">연속 매매거래일</div>
    ...
    <div class="rule-flow">
      <div class="rule-flow-box">
        ...
        <div class="rule-flow-value num-hl">1만주 미만</div>
      </div>
      <div class="rule-flow-arrow">→</div>
      <div class="rule-flow-box highlight">
        <div class="rule-flow-label">관리종목 지정</div>
    ...
    아래는 그 원문입니다.</p>
    <h4>관리종목 지정기준 (제64조제1항)</h4>
    ${lawArticle('제64조제1항제4호 (거래량 미달)',
      '반기의 월평균거래량이 ⟦1만주 미만⟧인 경우. 다만, 다음 각 목의 어느 하나에 해당하는 경우에는 이 호를 적용하지 않는다.\n가. 종류주권이 신규로 상장된 경우(신규상장일이 속하는 반기에 한정)\n나. 반기 중 매매거래정지일 수가 해당 반기의 매매거래일 수의 ⟦100분의 50⟧ 이상인 경우\n다. 해당 반기 말 현재 유동성공급계약(계약기간 ⟦6개월⟧ 이상)이 체결되어 있는 경우')}
    ${lawArticle('제64조제1항제5호 (시가총액 미달)',
      '상장시가총액이 ⟦20억원⟧에 미달하는 상태가 ⟦30일⟧(해당 주권의 매매거래일 기준) 동안 계속되는 경우.')}
    <p class="info">이 외에도 발행인 자격 미달(1호, 보통주권 관리종목 지정 시)ㆍ일반주주 수 미달(2호,
    <b class="num-hl">100명 미만</b>)ㆍ상장주식 수 미달(3호, <b class="num-hl">20만주 미만</b>) 사유가
    있지만, 이 화면은 거래량ㆍ시가총액 2가지만 모니터링합니다.</p>
    <h4>상장폐지 기준 (제65조제1항)</h4>
    ${lawArticle('제65조제1항제4호 (거래량 미달)',
      '거래량 미달로 제64조제1항제4호에 따라 관리종목으로 지정된 상태에서 다음 반기에도 월평균거래량이 ⟦1만주 미만⟧인 경우. 다만, 제64조제1항제4호 각 목(신규상장ㆍ매매정지 ⟦50% 이상⟧ㆍ유동성공급계약)의 어느 하나에 해당하는 경우에는 이 호를 적용하지 않는다.')}
    ${lawArticle('제65조제1항제5호 (시가총액 미달)',
      '시가총액 미달로 제64조제1항제5호에 따라 관리종목으로 지정된 후 ⟦90일⟧(매매거래일 기준) 동안 상장시가총액이 다음 각 목의 어느 하나라도 충족하지 못하는 경우\n가. ⟦20억원 이상⟧인 상태가 ⟦10일 이상⟧ 계속될 것\n나. ⟦20억원 이상⟧인 일수가 ⟦30일 이상⟧일 것')}
    <p class="info">즉 시가총액 미달은 "관리종목 지정 후 <b class="num-hl">90일</b> 안에
    <b class="num-hl">20억원</b>을 한 번이라도 넘기면 그만"이 아니라, <b class="num-hl">90일</b> 동안
    <b class="num-hl">20억원 이상</b>인 날이 최소 <b class="num-hl">10일 연속</b>(가목) 또는 누적
    <b class="num-hl">30일 이상</b>(나목) 중 하나를 충족해야 상장폐지를 면합니다. 거래량 미달은
    "다음 반기에도 연속으로 <b class="num-hl">1만주 미만</b>"이면 폐지 — 즉 지정 후 첫 반기는 유예,
...
function ruleMgmtVolumeCalcHtml() {
  ...
  return `
    <p>"이번 반기 잠정 월평균거래량"은 유가증권시장 상장규정 <b>시행세칙 제43조(거래량 미달
    사유의 적용방법)</b>의 산식을 그대로 적용한 값입니다 — 추정치가 아니라, 지금까지 실제로
    체결된 거래량을 그 산식에 넣어 계산한 값입니다.</p>
    <h4>제43조① 산식</h4>
    <div class="rule-flow">
      <div class="rule-flow-box">
        <div class="rule-flow-label">반기 중 매매거래일(A)</div>
        <div class="rule-flow-value">시장 전체 개장일</div>
      </div>
      <div class="rule-flow-arrow">÷</div>
      <div class="rule-flow-box">
        <div class="rule-flow-label">반기 중 해당 주권의 매매거래일(B)</div>
        <div class="rule-flow-value">이 종목 실제 거래일</div>
      </div>
      <div class="rule-flow-arrow">×</div>
      <div class="rule-flow-box">
        <div class="rule-flow-label">반기 총 거래량(C)</div>
        <div class="rule-flow-value">누적 거래량</div>
      </div>
      <div class="rule-flow-arrow">÷ 6 =</div>
      <div class="rule-flow-box highlight">
        <div class="rule-flow-label">${label} 월평균거래량</div>
        <div class="rule-flow-value">잠정치</div>
      </div>
    </div>
    <p class="info">조문 원문: "① … 반기 월평균거래량은 … 반기 총 거래량(해당 주권의 매매거래일을
    고려한다)을 6개월로 나누어 산출한 수량을 말한다. 이 경우 산출산식은 「[(반기 중 매매거래일 ÷
    반기 중 해당 주권의 매매거래일) × 반기 총 거래량] / 6」으로 한다."</p>
    <h4>계산 방식</h4>
    <ul>
      <li><b>A(반기 중 매매거래일)</b>: 반기 시작일부터 기준일까지 시장 전체가 열린 날 수 —
        매매정지 없이 항상 거래되는 동양(보통주) 거래일수를 기준으로 삼습니다.</li>
      <li><b>B(반기 중 해당 주권의 매매거래일)</b>: 같은 기간 이 종목이 실제로 거래된 날 수 —
        매매정지로 거래가 아예 없었던 날은 빠집니다. A보다 B가 작을수록(매매정지 기간이
        길수록) A÷B 배율만큼 거래량이 증폭돼 매매정지 공백을 보정합니다.</li>
      <li><b>C(반기 총 거래량)</b>: 반기 시작일부터 기준일까지의 실제 일별 거래량 합계입니다
        (감자ㆍ병합 시 조정 포함, 아래 참고).</li>
      <li>산식이 "÷6"으로 반기 전체(6개월)를 상정하므로, 반기가 아직 끝나지 않은 시점에는
        지금까지의 A/B/C만 넣어 계산한 값이라 작게 나올 수 있습니다 — "지금 이 순간 반기가
        끝난다면"의 최소치(하한선)로 이해해 주세요. 남은 기간 거래가 쌓일수록 이 값은
        계속 올라가기만 합니다(단조증가).</li>
      <li>사이드바 "현재기준" 탭에서는 오늘자가 아직 KRX 확정 이력에 반영되지 않았을 때만
        오늘 장중 실시간 누적거래량을 임시로 더해 같은 산식을 다시 계산합니다.</li>
      <li>"장마감기준" 탭은 항상 KRX가 공식 확정한 이력만으로 계산해서, 실시간가 변동과 무관하게
        고정된 값을 보여줍니다.</li>
    </ul>
    <h4>제43조② — 감자(액면병합) 등으로 반기 중 변경상장한 경우</h4>
    <p>동양우ㆍ동양2우B는 2026.7.20 감자(액면병합, 구주 2주→신주 1주)로 <b>변경상장</b>했습니다
    (신규상장이 아닙니다). 조문 원문: "② … 해당 반기 중에 병합, 분할, 증자 또는 감자가 있는
    경우의 변경상장 또는 신주상장 전의 거래량은 … 1. 병합 또는 분할의 경우에는 해당 병합 또는
    분할비율에 따라 조정한다." 병합 전ㆍ후는 1주가 표상하는 발행주식총수 자체가 달라져서
