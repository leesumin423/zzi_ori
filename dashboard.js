...
function ruleMgmtCommonHtml() {
  return `
    ...
    ${lawArticle('유가증권시장 상장규정 제48조제1항제9호의2 (주가 미달, 2026.5.13 신설)',
      '제47조제1항제9호의2에 따라 관리종목으로 지정된 후 90일(해당 보통주권의 매매거래일을 기준으로 한다) 이내에 다음 각 목의 어느 하나의 사유에 해당하는 경우 해당 보통주권을 상장폐지한다.\n가. 해당 보통주식의 종가가 1,000원 이상인 상태가 45일 이상 계속되지 못하는 경우\n나. 주식병합 또는 자본금의 감소에 따른 변경상장을 완료한 경우로서 관리종목 지정일로부터 과거 1년 이내에 주식병합 또는 자본금의 감소에 따른 변경상장이 있었던 경우\n다. 주식병합 또는 자본금의 감소에 따른 변경상장을 1회 이상 완료한 경우로서 해당 주식병합 또는 자본금 감소의 총 비율이 10대1을 초과하는 경우')}
    <p class="info">즉 관리종목 <b>지정</b>은 종가 1,000원 미만이 <b>30매매거래일 연속</b>되면 발생하지만,
    상장폐지를 면하려면 지정 후 <b>90매매거래일 이내에 종가 1,000원 이상 상태를 45매매거래일 이상
    유지</b>해야 합니다 — 30일ㆍ90일ㆍ45일 세 가지 숫자가 각각 지정ㆍ유예ㆍ해소 기준으로 다르게 쓰이니
    혼동하지 않도록 주의하세요. 나ㆍ다목은 무상감자성 주식병합으로 주가를 인위적으로 띄워 규정을
    회피하는 것을 막는 보완장치입니다(지정일 전 1년 이내 병합ㆍ감자 이력이 있거나, 누적 병합ㆍ감자
    비율이 10대1을 넘으면 종가 기준 충족 여부와 무관하게 상장폐지).</p>
    <h4>관리종목 지정 해제</h4>
    ${lawArticle('유가증권시장 상장규정 시행세칙 별표7 (관리종목지정ㆍ해제 시기) — "9) 주가 미달" 항목',
      '지정사유: 규정 제47조제1항제9호의2 (보통주권 종가가 1,000원 미만인 상태가 30매매거래일간 계속)\n지정시기: 해당 사유 발생일의 다음날\n해제사유: 종가가 규정 제48조제1항제9호의2에서 정하는 기준(1,000원) 이상인 상태가 45매매거래일 이상 계속될 것\n해제시기: 해제 사유 발생일의 다음날')}
...
function ruleMgmtPreferredHtml() {
  return `
    ...
    ${lawArticle('제64조제1항제4호 (거래량 미달)',
      '반기의 월평균거래량이 1만주 미만인 경우. 다만, 다음 각 목의 어느 하나에 해당하는 경우에는 이 호를 적용하지 않는다.\n가. 종류주권이 신규로 상장된 경우(신규상장일이 속하는 반기에 한정)\n나. 반기 중 매매거래정지일 수가 해당 반기의 매매거래일 수의 100분의 50 이상인 경우\n다. 해당 반기 말 현재 유동성공급계약(계약기간 6개월 이상)이 체결되어 있는 경우')}
    ${lawArticle('제64조제1항제5호 (시가총액 미달)',
      '상장시가총액이 20억원에 미달하는 상태가 30일(해당 주권의 매매거래일 기준) 동안 계속되는 경우.')}
    <p class="info">이 외에도 발행인 자격 미달(1호, 보통주권 관리종목 지정 시)ㆍ일반주주 수 미달(2호, 100명 미만)ㆍ
    상장주식 수 미달(3호, 20만주 미만) 사유가 있지만, 이 화면은 거래량ㆍ시가총액 2가지만 모니터링합니다.</p>
    <h4>상장폐지 기준 (제65조제1항)</h4>
    ${lawArticle('제65조제1항제4호 (거래량 미달)',
      '거래량 미달로 제64조제1항제4호에 따라 관리종목으로 지정된 상태에서 다음 반기에도 월평균거래량이 1만주 미만인 경우. 다만, 제64조제1항제4호 각 목(신규상장ㆍ매매정지 50% 이상ㆍ유동성공급계약)의 어느 하나에 해당하는 경우에는 이 호를 적용하지 않는다.')}
    ...
    <p class="info">즉 시가총액 미달은 "관리종목 지정 후 90일 안에 20억원을 한 번이라도 넘기면 그만"이
    아니라, <b>90일 동안 20억원 이상인 날이 최소 10일 연속(가목) 또는 누적 30일 이상(나목) 중 하나를
    충족해야</b> 상장폐지를 면합니다. 거래량 미달은 "다음 반기에도 연속으로 1만주 미만"이면 폐지 —
    즉 지정 후 첫 반기는 유예, 그다음 반기까지 계속 미달이면 폐지되는 2단계 구조입니다.</p>
